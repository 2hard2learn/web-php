...
$sql="SELECT * FROM shop LIMIT $start_page,$per_page";
$result=mysqli_query($con,$sql);
if(mysqli_num_rows($result)>0){
    ...
    echo $row["description"]."</td><td>".$row["price"]."</td><td><img src=".$row["picture"]." width=100 height=100></td>";
...
echo "<table><tr><th>ลำดับ</th><th>ID</th><th>Name</th><th>Description</th><th>Price</th><th>picture</th></tr>";
    for($i=0;$i<count($_SESSION["cart"]);$i++)
    {
        ...
        echo "<td><img src=".$item['picture']." width=100 height=100></td>";
